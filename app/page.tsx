      ...
      >
        <div className="w-full max-w-screen-sm mx-auto bg-background">
          ...
          <div className="space-y-3 mt-3">
            <div className="grid grid-cols-6 sm:grid-cols-7 font-archivoBold text-textColor px-2 py-1 rounded-lg bg-white">
              <div className="text-xs font-archivoBold">Début</div>
              <div className="sm:col-span-2 text-xs font-archivoBold pl-4">Nom</div>
